...
- **Translations:** add or edit under `docs/i18n/<locale>/` only (ru, et, ja). Keep each language on separate pages — do not mix languages on one file. Link English technical docs with **(English)** labels.
